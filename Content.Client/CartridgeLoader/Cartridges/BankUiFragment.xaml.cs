...
{
    public event Action? OnWithdrawButtonPressed;
    ...
    public BankUiFragment()
    {
        ...
        Withdraw.OnPressed += _ => OnWithdrawButtonPressed?.Invoke();
        Deposit.OnPressed += _ => OnDepositButtonPressed?.Invoke();
        Back.OnPressed += _ => OnBackButtonPressed?.Invoke();
    }
